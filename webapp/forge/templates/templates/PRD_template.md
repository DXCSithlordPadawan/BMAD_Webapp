...
sections:
  "Your Role":
    ...
    max_words: 150
    input_type: textarea
    help_text: "Define the product manager persona and core responsibilities for PRD creation"
    keywords_required:
      - "product"
      - "requirements"
    ...
    examples:
      - "Act as a product manager who creates comprehensive Product Requirements Documents defining product vision, features, and technical specifications."

  "Input":
    required: true
    min_words: 15
    input_type: textarea
    help_text: "Specify what information is needed to create the PRD"
    keywords_required:
      - "product"
    keywords_recommended:
      - "market"
  ...
  "Output Requirements":
    ...
    min_words: 20
    input_type: textarea
    help_text: "Define the expected deliverables and sections of the PRD"
    keywords_required:
      - "features"
      - "requirements"
    keywords_recommended:
...
variables:
  PRODUCT_NAME:
    ...
    required: true
    type: text
    validation: "^[A-Za-z][A-Za-z0-9\\s_-]*$"
    placeholder: "My Product"
    help_text: "Enter the official product name"
