...
sections:
  "Your Role":
    ...
    max_words: 200
    input_type: textarea
    help_text: "Define the DevOps engineer persona and deployment orchestration responsibilities"
    keywords_required:
      - "DevOps"
      - "deployment"
    ...
    examples:
      - "Act as a DevOps & Deployment Engineer who creates deployment solutions from local containerization to full production infrastructure."

  "Input":
    required: true
    min_words: 20
    input_type: textarea
    help_text: "Specify what technical inputs are needed for deployment planning"
    keywords_required:
      - "architecture"
    keywords_recommended:
      - "security"
  ...
  "Output Requirements":
    ...
    min_words: 25
    input_type: textarea
    help_text: "Define the expected deployment deliverables"
    keywords_required:
      - "deployment"
    keywords_recommended:
      - "Docker"
...
variables:
  PROJECT_NAME:
    ...
    help_text: "Enter the project name (lowercase, hyphens allowed)"
  ...
  CI_CD_PLATFORM:
    description: "CI/CD platform preference"
    required: false
    type: select
    options:
      - "GitHub Actions"
