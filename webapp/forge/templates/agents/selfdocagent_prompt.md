...
sections:
  "Your Role":
    ...
    examples:
      - "Act as a technical documentation specialist who creates comprehensive feature documentation for non-professional developers."

  "Input":
    required: true
    min_words: 15
    input_type: textarea
    help_text: "Specify inputs needed for feature documentation"
    keywords_required:
      - "feature"
    keywords_recommended:
      - "codebase"
...
variables:
  ...
  AUDIENCE_LEVEL:
    description: "Target audience technical level"
    required: false
    type: select
    options:
      - "Non-Technical"
