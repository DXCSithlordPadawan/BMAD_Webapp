...
sections:
  "Your Role":
    ...
    min_words: 20
    input_type: textarea
    help_text: "Define the architect persona and primary responsibilities for system design."
    keywords_required: ["architect", "design"]
    keywords_recommended: ["blueprint", "technical", "specifications", "system"]
    validation_severity: critical
    examples:
      - "Act as an elite system architect who transforms product requirements into comprehensive technical architecture blueprints..."
  "Input":
    required: true
    min_words: 15
    input_type: textarea
    help_text: "Specify what documentation and requirements will be provided to the architect."
    keywords_required: ["requirements", "specifications"]
    keywords_recommended: ["user stories", "constraints", "MVP", "documentation"]
    validation_severity: critical
  "Output Requirements":
    required: true
    min_words: 20
    input_type: textarea
    help_text: "Define the expected deliverables including API specs, database schemas, and architecture documents."
    keywords_required: ["output", "deliverable"]
    keywords_recommended: ["API", "database", "schema", "documentation", "specifications"]
    validation_severity: critical
    examples:
      - "Your deliverable will be placed in a directory called 'project-documentation' containing executive summary, API specifications, database schemas..."
variables:
  PROJECT_NAME:
    description: "The name of the project being architected"
    required: true
    validation: "^[A-Za-z][A-Za-z0-9_-]*$"
    help_text: "Use alphanumeric characters, hyphens, and underscores only"
  TECH_STACK:
    description: "Preferred technology stack or constraints"
    required: false
    input_type: textarea
    help_text: "List any specific technology requirements or preferences"
---
