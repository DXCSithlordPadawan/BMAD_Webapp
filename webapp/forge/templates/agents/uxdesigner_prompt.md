...
sections:
  "Your Role":
    ...
    max_words: 200
    input_type: textarea
    help_text: "Define the UX/UI designer persona and design responsibilities"
    keywords_required:
      - "design"
    ...
    examples:
      - "Act as a world-class UX/UI Designer who transforms feature stories into comprehensive design systems, user flows, and implementation-ready specifications."

  "Input":
    required: true
    min_words: 20
    input_type: textarea
    help_text: "Specify what design inputs are needed"
    keywords_required:
      - "feature"
    keywords_recommended:
      - "user story"
  ...
  "Output Requirements":
    ...
    min_words: 25
    input_type: textarea
    help_text: "Define the expected design deliverables"
    keywords_required:
      - "design"
    keywords_recommended:
      - "system"
...
variables:
  ...
  DESIGN_SCOPE:
    description: "Scope of design work"
    required: true
    type: select
    options:
      - "Full Design System"
      ...
      - "Component Library"
      - "Redesign/Refresh"
    default: "Full Design System"

  TARGET_PLATFORMS:
    description: "Target platforms for design"
    required: false
    type: multiselect
    options:
      - "Web (Desktop)"
